...
export abstract class AbstractTokenizer implements ITokenizer {
   ...
   */
  public async abstract readBuffer(buffer: Buffer | Uint8Array, offset?: number, length?: number, position?: number): Promise<number>;
  ...
  public async readToken<T>(token: IGetToken<T>, position: number | null = null): Promise<T> {
